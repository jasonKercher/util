                           ...
                           const unsigned props)
{
	...
	self->values = malloc(sizeof(vec));
	vec_construct(self->values, elem_size);
                                     ...
                                     const unsigned props)
{
	...
	self->_keys = malloc(sizeof(vec));
	vec_construct_(self->_keys, struct _keyloc);
                      ...
                      void* restrict data)
{
	...
	if (self->_key_temp == NULL) {
		self->_key_temp = malloc(sizeof(vec));
		vec_construct_(self->_key_temp, struct _keyloc);
	}
